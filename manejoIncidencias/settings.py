...
ADMINS = (
		('Miguel Ojeda', 'lanymicole@gmail.com'),
)
...
MEDIA_ROOT = os.path.join(RUTA_PROYECTO,'img')
...
ROOT_URLCONF = 'manejoIncidencias.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'manejoIncidencias.wsgi.application'
...
EMAIL_HOST_USER = 'lanymicole@gmail.com'
